...
RUN pip install "apache-airflow[async,postgres,google,amazon,cncf.kubernetes,sftp,postgres,redis,ssh,celery,http]==${AIRFLOW_VERSION}" --constraint "${CONSTRAINT_URL}"
